...
public record JetpackData(String id, double thrust, double maxYVelocity, double horizontalVelocity, int maxFuel, int consumption, String fuelId, ActivationType activationType, EquipmentSlot[] slots, JetpackEffect effect) {
